...
class Surface(object):
    """A class representing an infinite surface, on which Afferent objects can
    be placed.
    """
...
class Surface2D(Surface):
    """A class representing a finite 2D surface, which can be subdivided into
    separate regions, and on which Afferent objects can be placed.
    """

    def __init__(self,**args):
        """Initializes a Surface2D object.
...
class Surface3D(Surface):
    """A class representing a finite 3D surface, which can be subdivided into
    separate regions, and on which Afferent objects can be placed.
    """
...
hand_surface = Surface2D(filename=(os.path.dirname(os.path.dirname(__file__))\
